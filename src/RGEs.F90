...
Forall(i2=1:3)  CYx3TpYx3(i2,i2) =  Real(CYx3TpYx3(i2,i2),dp) 
 ...
 CTYb3TpTYb3 = Matmul2(Conjg(TYb3),Transpose(TYb3),OnlyDiagonal) 
 CTYdTpTYd = Matmul2(Conjg(TYd),Transpose(TYd),OnlyDiagonal) 
 CTYeTpTYe = Matmul2(Conjg(TYe),Transpose(TYe),OnlyDiagonal) 
 CTYuTpTYu = Matmul2(Conjg(TYu),Transpose(TYu),OnlyDiagonal) 
 CTYw3TpTYw3 = Matmul2(Conjg(TYw3),Transpose(TYw3),OnlyDiagonal) 
 CTYx3TpTYx3 = Matmul2(Conjg(TYx3),Transpose(TYx3),OnlyDiagonal) 
...
Forall(i2=1:3)  TpYx3CYx3(i2,i2) =  Real(TpYx3CYx3(i2,i2),dp) 
 ...
 md2YdadjYd = Matmul2(md2,YdadjYd,OnlyDiagonal) 
 md2adjYx3Yx3 = Matmul2(md2,adjYx3Yx3,OnlyDiagonal) 
 ...
 ml2adjYb3Yb3 = Matmul2(ml2,adjYb3Yb3,OnlyDiagonal) 
 ml2adjYeYe = Matmul2(ml2,adjYeYe,OnlyDiagonal) 
 ml2adjYw3Yw3 = Matmul2(ml2,adjYw3Yw3,OnlyDiagonal) 
...
If (TwoLoopRGE) Then 
 ...
 CTYb3TpYb3 = Matmul2(Conjg(TYb3),Transpose(Yb3),OnlyDiagonal) 
 CTYdadjYd = Matmul2(Conjg(TYd),adjYd,OnlyDiagonal) 
 CTYdadjYu = Matmul2(Conjg(TYd),adjYu,OnlyDiagonal) 
 CTYdTpYd = Matmul2(Conjg(TYd),Transpose(Yd),OnlyDiagonal) 
 ...
 CTYeTpYe = Matmul2(Conjg(TYe),Transpose(Ye),OnlyDiagonal) 
 CTYuadjYd = Matmul2(Conjg(TYu),adjYd,OnlyDiagonal) 
 CTYuadjYu = Matmul2(Conjg(TYu),adjYu,OnlyDiagonal) 
 CTYuTpYu = Matmul2(Conjg(TYu),Transpose(Yu),OnlyDiagonal) 
 ...
 CTYw3TpYw3 = Matmul2(Conjg(TYw3),Transpose(Yw3),OnlyDiagonal) 
 CTYx3adjYx3 = Matmul2(Conjg(TYx3),adjYx3,OnlyDiagonal) 
 CTYx3TYd = Matmul2(Conjg(TYx3),TYd,OnlyDiagonal) 
 CTYx3TpYd = Matmul2(Conjg(TYx3),Transpose(Yd),OnlyDiagonal) 
 CTYx3TpYx3 = Matmul2(Conjg(TYx3),Transpose(Yx3),OnlyDiagonal) 
 CTYx3TpTYd = Matmul2(Conjg(TYx3),Transpose(TYd),OnlyDiagonal) 
 ...
 TYx3CTYdTpYd = Matmul2(TYx3,CTYdTpYd,OnlyDiagonal) 
 ...
 TpYx3CTYx3TYd = Matmul2(Transpose(Yx3),CTYx3TYd,OnlyDiagonal) 
 TpYx3CTYx3TpTYd = Matmul2(Transpose(Yx3),CTYx3TpTYd,OnlyDiagonal) 
 ...
 TpTYx3CTYx3TpYd = Matmul2(Transpose(TYx3),CTYx3TpYd,OnlyDiagonal) 
...
Forall(i2=1:3)  adjYdTpYx3CYx3Yd(i2,i2) =  Real(adjYdTpYx3CYx3Yd(i2,i2),dp) 
 ...
 adjYdTpYx3CTYx3TYd = Matmul2(adjYd,TpYx3CTYx3TYd,OnlyDiagonal) 
 adjYdTpYx3CTYx3TpTYd = Matmul2(adjYd,TpYx3CTYx3TpTYd,OnlyDiagonal) 
 adjYdTpTYx3CYx3Yd = Matmul2(adjYd,TpTYx3CYx3Yd,OnlyDiagonal) 
 adjYdTpTYx3CTYx3TpYd = Matmul2(adjYd,TpTYx3CTYx3TpYd,OnlyDiagonal) 
...
Forall(i2=1:3)  adjYx3Yx3adjYx3Yx3(i2,i2) =  Real(adjYx3Yx3adjYx3Yx3(i2,i2),dp) 
 ...
 adjYx3TYx3CYdTpYd = Matmul2(adjYx3,TYx3CYdTpYd,OnlyDiagonal) 
 adjYx3TYx3CTYdTpYd = Matmul2(adjYx3,TYx3CTYdTpYd,OnlyDiagonal) 
...
Forall(i2=1:3)  TpYx3CYx3TpYx3CYx3(i2,i2) =  Real(TpYx3CYx3TpYx3CYx3(i2,i2),dp) 
 ...
 md2YdadjYuYuadjYd = Matmul2(md2,YdadjYuYuadjYd,OnlyDiagonal) 
 md2adjYx3Yx3adjYx3Yx3 = Matmul2(md2,adjYx3Yx3adjYx3Yx3,OnlyDiagonal) 
 ...
 mHxb32CYx3YdadjYdTpYx3 = Matmul2(mHxb32,CYx3YdadjYdTpYx3,OnlyDiagonal) 
 ml2adjYb3Yb3adjYb3Yb3 = Matmul2(ml2,adjYb3Yb3adjYb3Yb3,OnlyDiagonal) 
 ml2adjYb3Yb3adjYeYe = Matmul2(ml2,adjYb3Yb3adjYeYe,OnlyDiagonal) 
 ml2adjYb3Yb3adjYw3Yw3 = Matmul2(ml2,adjYb3Yb3adjYw3Yw3,OnlyDiagonal) 
 ml2adjYeYeadjYb3Yb3 = Matmul2(ml2,adjYeYeadjYb3Yb3,OnlyDiagonal) 
 ml2adjYeYeadjYeYe = Matmul2(ml2,adjYeYeadjYeYe,OnlyDiagonal) 
 ml2adjYeYeadjYw3Yw3 = Matmul2(ml2,adjYeYeadjYw3Yw3,OnlyDiagonal) 
 ml2adjYw3Yw3adjYb3Yb3 = Matmul2(ml2,adjYw3Yw3adjYb3Yb3,OnlyDiagonal) 
 ml2adjYw3Yw3adjYeYe = Matmul2(ml2,adjYw3Yw3adjYeYe,OnlyDiagonal) 
 ml2adjYw3Yw3adjYw3Yw3 = Matmul2(ml2,adjYw3Yw3adjYw3Yw3,OnlyDiagonal) 
